...
drawButton.addEventListener('click', async () => {
    ...
    try {
        ...
        // Obtenemos todos los datos necesarios: nombre, email y teléfono.
        ...
        while (!success && attempts < 10) {
            ...
            for (let i = 0; i < participants.length; i++) {
                ...
                pairingsMap[giver.id] = { 
                    ...
                    giverPhone: giver.phone, // <-- Añadimos el teléfono del dador
        ...
        // Se envía un array de objetos, que es más estándar y fácil de iterar.
...
function displayAssignmentLinks(links) {
    ...
    links.forEach(participant => {
        ...
        const whatsappMessage = `¡Hola ${participant.giverName}! 🎅\n\nAquí tienes tu enlace secreto para el sorteo del Amigo Secreto. ¡No lo compartas con nadie!\n\n${participant.link}`;
        
        // Codificar el mensaje para que sea parte de una URL
        const encodedMessage = encodeURIComponent(whatsappMessage);

        // Construir el enlace de WhatsApp (wa.me)
        // Nota: El número de teléfono debe estar en formato internacional sin '+' o '00'. Ej: 34123456789
    ...
    drawResultContainer.innerHTML = `
        <h3>¡Sorteo Realizado y Guardado! ✅</h3>
        <p>El emparejamiento secreto ha sido completado. <strong>Comparte el siguiente enlace con cada participante.</strong> Cada enlace es único y secreto.</p>
